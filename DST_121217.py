...
def berechnung(investCost, roofSpace, normPower, pvCap, data):
    ...
    maxNachfrage = np.max(data["Lastgang_[W]"])

    textErgebnis.insert(END, maxNachfrage)
    '''
    ...
    while (i < data.__len__()):
        ...
        print("Gesamtersparnis zum Zeipunkt: " + str[i*15] + " [Minuten] "+ str(ersparnis))  # zur Überprüfung der Rechnung in der Konsole
        i = i + 1
